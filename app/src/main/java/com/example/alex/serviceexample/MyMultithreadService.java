...
public class MyMultithreadService extends Service {

//    private static final String TAG = MyMultithreadService.class.getSimpleName();
    private static final String TAG = "MyMultithreadService";
